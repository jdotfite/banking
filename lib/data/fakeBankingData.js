...
const formatCurrency = (amount) => {
  ...
  const generateFakeUsers = () => {    // --- USER 1: Young Professional ---
    const user1 = {
      id: 'user1',
      ...
      todoItems: {
        ...
        items: [
          ...
          { id: '2', title: 'Add to Apple Wallet', completed: true },
          { id: '3', title: 'Set up PIN', completed: true },
    ...
    const newUser = {
      ...
      todoItems: {
        ...
        totalCount: 4,
        items: [
          { id: '1', title: 'Activate your card', completed: false },
          { id: '2', title: 'Add to Apple Wallet', completed: false },
          { id: '3', title: 'Set up PIN', completed: false },
          { id: '4', title: 'Enable alerts', completed: false }
        ]
